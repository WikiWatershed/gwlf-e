...
from FilterEff import FilterEff_f
# from Timer import time_function
from Memoization import memoize
from NLU import NLU
from RetentionEff import RetentionEff
from RetentionEff import RetentionEff_f
from SurfaceLoad import SurfaceLoad
from SurfaceLoad import SurfaceLoad_f
...
@memoize
def SurfaceLoad_1_f(NYrs, DaysMonth, InitSnow_0, Temp, Prec, NRur, NUrb, Area, CNI_0, AntMoist_0, Grow_0, CNP_0,
                    Imper, ISRR, ISRA, Qretention, PctAreaInfil, Nqual, LoadRateImp, LoadRatePerv, Storm, UrbBMPRed,
                    FilterWidth, PctStrmBuf):
    nlu = NLU(NRur, NUrb)
