...
#     return result
#
# def UrbSedLoad_f(NYrs, DaysMonth, Temp, InitSnow_0, Prec, NRur, NUrb, Area, CNI_0,
#            AntMoist_0, Grow_0, CNP_0, Imper, ISRR, ISRA, Qretention, PctAreaInfil,
#            Nqual, LoadRateImp, LoadRatePerv, Storm, UrbBMPRed,
#            FilterWidth, PctStrmBuf):
#     return np.reshape(np.repeat(np.sum(LuLoad_f(NYrs, DaysMonth, Temp, InitSnow_0, Prec, NRur, NUrb, Area, CNI_0,
#            AntMoist_0, Grow_0, CNP_0, Imper, ISRR, ISRA, Qretention, PctAreaInfil,
#            Nqual, LoadRateImp, LoadRatePerv, Storm, UrbBMPRed,
