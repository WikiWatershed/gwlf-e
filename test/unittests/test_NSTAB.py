...
class TestNSTAB(unittest.TestCase):
    ...
    def test_NSTAB(self):
        ...
        np.testing.assert_array_almost_equal(
            NSTAB.NSTAB_2(z.NYrs, z.DaysMonth, z.Temp, z.InitSnow_0, z.Prec, z.NRur, z.NUrb, z.Area,
            ...
            NSTAB.NSTAB(z.NYrs, z.DaysMonth, z.Temp, z.InitSnow_0, z.Prec, z.NRur, z.NUrb, z.Area,
                          ...
                          z.TileDrainDensity, z.PointFlow, z.StreamWithdrawal, z.GroundWithdrawal,
                          z.NumAnimals, z.AvgAnimalWt, z.StreamFlowVolAdj, z.SedAFactor_0, z.AvKF,
                          z.AvSlope, z.SedAAdjust, z.StreamLength, z.n42b, z.n46c, z.SedNitr, z.BankNFrac, z.n69c), decimal=7)
