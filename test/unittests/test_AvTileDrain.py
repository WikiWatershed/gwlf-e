...
from gwlfe import AvTileDrain


class TestAvTileDrain(unittest.TestCase):
    def setUp(self):
    ...
    def test_AvTileDrain(self):
        ...
        np.testing.assert_array_almost_equal(
            AvTileDrain.AvTileDrain_2(z.NYrs, z.DaysMonth, z.Temp, z.InitSnow_0, z.Prec, z.NRur, z.NUrb, z.Area,
