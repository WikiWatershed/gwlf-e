...
from gwlfe import AvGroundWater


class TestAvGroundWater(unittest.TestCase):
    def setUp(self):
    ...
    def test_AvGroundWater(self):
        ...
        np.testing.assert_array_almost_equal(
            AvGroundWater.AvGroundWater_2(z.NYrs, z.DaysMonth, z.Temp, z.InitSnow_0, z.Prec, z.NRur, z.NUrb, z.Area,
