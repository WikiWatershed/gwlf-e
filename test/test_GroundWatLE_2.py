...
class TestGroundWatLE_2(unittest.TestCase):
    ...
    def test_GroundWatLE_2_ground_truth(self):
        ...
        np.testing.assert_array_almost_equal(
            np.load("GroundWatLE_2.npy"),
            GroundWatLE_2.GroundWatLE_2(z.NYrs, z.DaysMonth, z.Temp, z.InitSnow_0, z.Prec, z.NRur, z.NUrb, z.Area, z.CNI_0, z.AntMoist_0, z.Grow, z.CNP_0, z.Imper,
