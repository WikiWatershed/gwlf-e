...
from gwlfe import AvStreamBankEros


class TestAvStreamBankEros(unittest.TestCase):
    def setUp(self):
    ...
    def test_AvStreamBankEros(self):
        ...
        np.testing.assert_array_almost_equal(
            AvStreamBankEros.AvStreamBankEros_2(z.NYrs, z.DaysMonth, z.Temp, z.InitSnow_0, z.Prec, z.NRur, z.NUrb,
